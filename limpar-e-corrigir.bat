...
echo.
echo 5. Verificando se o RobotJS foi compilado...
if not exist node_modules\robotjs\build\Release\robotjs.node (
    echo [AVISO] RobotJS nao compilou no install. Tentando forcar agora...
    call npx @electron/rebuild -v 29.4.0 -f -m . -w robotjs
)
